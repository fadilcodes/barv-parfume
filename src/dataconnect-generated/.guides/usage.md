...
```ts
import { useAllPerfumes, useUserLists, useCreateReview, useUpdateUserProfile } from '@dataconnect/generated/react';
// The types of these hooks are available in react/index.d.ts

const { data, isPending, isSuccess, isError, error } = useAllPerfumes();

const { data, isPending, isSuccess, isError, error } = useUserLists();
...
```js
import { allPerfumes, userLists, createReview, updateUserProfile } from '@dataconnect/generated';


// Operation AllPerfumes: 
